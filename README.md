...
shared in case they're useful to others. This repo is a running set of notes
on how I use AI day to day: agent setups, CLI tools, configuration tricks,
prompts that work well, and things I learned the hard way. It's informal and
grows organically rather than following a fixed structure, since most of what
I learn about working with AI tools doesn't fit neatly into a blog post or a
single polished writeup — this is a place to capture it as it happens.
